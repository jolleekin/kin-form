...
// A named, reusable field built around `useWatch` — worth doing once a
// field's markup (label, input, error message) repeats across a form, as it
// does here for email and password. Taking an already-resolved `api` (see
// `Watch`'s own doc comment) rather than `parent`+`name` keeps this generic
// over just `TParentValue`, without needing a `DeepKey` bound of its own.
