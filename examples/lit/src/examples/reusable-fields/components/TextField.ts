...
// A named, reusable field built around `WatchController` - worth doing once
// a field's markup (label, input, error message) repeats across a form, as
// it does here for email and password.
...
customElements.define("reusable-fields-text-field", TextField);

declare global {
  interface HTMLElementTagNameMap {
    "reusable-fields-text-field": TextField;
  }
}
